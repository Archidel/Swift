...
public final class SQLCommand {
	private SQLCommand() {}
// FOREING KEY
	public static final String FOREING_KEY_CHECKS_FALSE = "SET FOREIGN_KEY_CHECKS=0";
	public static final String FOREING_KEY_CHECKS_TRUE = "SET FOREIGN_KEY_CHECKS=1";
//REQUEST ON SERVICE
