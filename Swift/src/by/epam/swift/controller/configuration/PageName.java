...
//REDIRCET	
	public static final String REDIRECT_ERROR_PAGE = "/Controller?command=redirect&pagename=errorpage&message=An error occurred during the operation&status=false";
	public static final String REDIRECT_EDIT_NEWS_PAGE = "/Controller?command=upload_news_data_to_edit&news_id=";
	public static final String REDIRECT_GET_NEWS_LIST_ADMIN_PAGE = "/Controller?command=get_news_list_admin&page=1";			
